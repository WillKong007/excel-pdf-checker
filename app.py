...
# ------------------------------------------------------------
# 1. ALPHANUMERIC (ENGLISH & NUMBERS) CHECKER (ORIGINAL)
# ------------------------------------------------------------
EN_CONFIG = {
...
# ------------------------------------------------------------
# 2. CHINESE CHECKER (SIMPLIFIED – REDUNDANCY REMOVED)
# ------------------------------------------------------------
ZH_CONFIG = {
...
class ExcelPDFChineseChecker:
    ...
    # --- SIMPLIFIED compare_content: ONLY CALLS check_cell_presence ---
    def compare_content(self, excel_text, pdf_text, cell_map):
        ...
        for (sheet, ref), val in cell_map.items():
            ...
            # ---- RUN THE COMPREHENSIVE CHECK (covers everything) ----
